...
const { getOneTrip } = require('../services/trip-service');
...
const updateTripStatus = catchAsync(async (req, res) => {
    ...
    const trip = await getOneTrip(req.params.trip_id);
    ...
    if (trip.status === 'requested') {
        ...
        if (req.body.status === 'canceled') {
            ...
            // find another driver
            const nearbyDrivers = await findNearbyDrivers(req.body.origin.coordinates, trip.rejectedBy);
